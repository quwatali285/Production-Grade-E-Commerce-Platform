...
const CreateProduct = ({ id, onClose }) => {
  ...
  const CreateProducthandler = async (e) => {
    ...
    await axios.post('http://localhost:8000/admin/createproduct',
      formData
    )
    setname('')
    setprice('')
    setimage(null)
    onClose(); // 🔥 THIS IS WHAT YOU MISSED
  }
  return (
    <>
      <div className="fixed inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-sm z-50">
        <div className='flex flex-col'>
          ...
          <form
            ...
            className='bg-zinc-700 p-4 border-[1px] border-zinc-500 text-white rounded-md w-[60vw] flex flex-col gap-4 shadow-lg '
          >
              ...
              <div className='flex flex-col'>
                ...
                <div>
                  ...
                  <input
                    ...
                    className='w-full mt-1 px-3 h-10 rounded bg-zinc-800 border border-zinc-500 outline-none text-white  tracking-widest'
                    type='text'
                ...
                <div>
                  ...
                  <input
                    className='w-full mt-1 px-3 h-10 rounded bg-zinc-800 border border-zinc-500 outline-none text-white text-center tracking-widest'
                    type="file"
